...
public class Constant {
    //切环境时候注意融云ID变更
//            public static String BASE_URL = "https://develop.api.ulaidao.cn/worker/v1/";
//        public static String BASE_URL = "https://stage.api.ulaidao.cn/worker/v1/";
    public static String BASE_URL = "http://api.ulaidao.cn/worker/v1/";
    public static String ONLINE_BASE_URL = "http://api.ulaidao.cn/worker/v1/";
