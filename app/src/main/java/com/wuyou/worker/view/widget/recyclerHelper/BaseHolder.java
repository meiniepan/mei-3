...
public class BaseHolder extends RecyclerView.ViewHolder {
     ...
     * @return The BaseHolder for chaining.
     */
    ...
    public BaseHolder addOnClickListener(@IdRes final int viewId) {
     ...
     * @return
     */
    public BaseHolder setNestView(@IdRes int viewId) {
     ...
     */
    @SuppressWarnings("unchecked")
    public BaseHolder addOnLongClickListener(@IdRes final int viewId) {
     ...
     */
    @Deprecated
    public BaseHolder setOnTouchListener(@IdRes int viewId, View.OnTouchListener listener) {
        View view = getView(viewId);
     ...
     */
    @Deprecated
    public BaseHolder setOnItemClickListener(@IdRes int viewId, AdapterView.OnItemClickListener listener) {
     ...
     * @return The BaseHolder for chaining.
     */
    public BaseHolder setOnItemLongClickListener(@IdRes int viewId, AdapterView.OnItemLongClickListener listener) {
        AdapterView view = getView(viewId);
     ...
     * @return The BaseHolder for chaining.
     */
    public BaseHolder setOnItemSelectedClickListener(@IdRes int viewId, AdapterView.OnItemSelectedListener listener) {
        AdapterView view = getView(viewId);
     ...
     * @return The BaseHolder for chaining.
     */
    public BaseHolder setOnCheckedChangeListener(@IdRes int viewId, CompoundButton.OnCheckedChangeListener listener) {
    ...
    public BaseHolder setChecked(@IdRes int viewId, boolean checked) {
        View view = getView(viewId);
        // ViewI unable cast to Checkable
     ...
     */
    @SuppressWarnings("unchecked")
    public BaseHolder setAdapter(@IdRes int viewId, Adapter adapter) {
        AdapterView view = getView(viewId);
     ...
     * @return The BaseHolder for chaining.
     */
    protected BaseHolder setAdapter(BaseQuickAdapter adapter) {
