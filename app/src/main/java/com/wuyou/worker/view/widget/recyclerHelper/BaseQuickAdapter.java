...
import com.wuyou.worker.view.widget.recyclerHelper.loadmore.LoadMoreView;
import com.wuyou.worker.view.widget.recyclerHelper.loadmore.SimpleLoadMoreView;
 ...
 */
public abstract class BaseQuickAdapter<T, K extends BaseHolder> extends RecyclerView.Adapter<K> {
    ...
    private void bindViewClickListener(final BaseHolder baseViewHolder) {
    ...
    /**
     * if you want to use subclass of BaseHolder in the adapter,
    ...
    protected K createBaseViewHolder(View view) {
        ...
        return null != k ? k : (K) new BaseHolder(view);
    }
    ...
    private void autoLoadMore(int position) {
        ...
        if (mLoadMoreView.getLoadMoreStatus() == LoadMoreView.STATUS_FAIL || mLoadMoreView.getLoadMoreStatus() == LoadMoreView.STATUS_END) {
            return;
        }
    ...
    public View getViewByPosition(RecyclerView recyclerView, int position, @IdRes int viewId) {
        ...
        BaseHolder viewHolder = (BaseHolder) recyclerView.findViewHolderForLayoutPosition(position);
        if (viewHolder == null) {
            return null;
        }
    ...
    /**
     * Register a callback to be invoked when an itemchild in ViewI has
     * been  clicked
     *
    ...
    /**
     * Register a callback to be invoked when an itemchild  in this ViewI has
     * been long clicked and held
     *
     * @param listener The callback that will run
     */
