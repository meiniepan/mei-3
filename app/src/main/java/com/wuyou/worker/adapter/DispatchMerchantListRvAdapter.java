...
public class DispatchMerchantListRvAdapter extends BaseQuickAdapter<WorkerEntity, BaseHolder> {
    private Activity activity;

    public DispatchMerchantListRvAdapter(Activity activity, int layoutResId, @Nullable List<WorkerEntity> data) {
