...
package com.wuyou.worker.util.zxing.camera;
...
public final class CameraManager {
    ...
    public static void init(Context context) {
        MIN_FRAME_WIDTH = CommonUtil.getScreenWidth(context) * 3 / 5;
        MIN_FRAME_HEIGHT = MIN_FRAME_WIDTH;
        MAX_FRAME_WIDTH = MIN_FRAME_WIDTH;
        MAX_FRAME_HEIGHT = MIN_FRAME_WIDTH;
    ...
    public void openDriver(SurfaceHolder holder) throws IOException {
        if (camera == null) {
            ...
            if (parameters == null || !open_result) {
                camera.release();
                camera = null;
                throw new IOException();
            }
...
//            FlashlightManager.enableFlashlight();
    ...
    public void switchFlash() {
        ...
        String flashmod = parameters.getFlashMode();
        List<String> flashModes = parameters.getSupportedFlashModes();
        if (null != flashmod && null != flashModes) {
            if (flashmod.equals("torch") && flashModes.contains(Camera.Parameters.FLASH_MODE_OFF)) {
                parameters.setFlashMode(Camera.Parameters.FLASH_MODE_OFF);
                camera.setParameters(parameters);
            } else if (flashModes.contains(Camera.Parameters.FLASH_MODE_TORCH)) {
